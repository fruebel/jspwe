                ...
                case "listar":
                    ...
                    try {
                        ...
                        for (Segperfiles objperfiles : lista) {
                            ...
                            botonEditar = "<a id='" + objperfiles.getIdperfil() + "'  onclick='editar(this);'  class='btn-floating  waves-effect waves-light red tooltipped' href='#modal1' data-position='left' data-delay='100' data-tooltip='Editar Registro' ><i class='material-icons md-18'>mode_edit</i></a>";
